...
generate:
	mkdir -p pkg/note_v1
	protoc --proto_path vendor.protogen --proto_path api/note_v1 --go_out=pkg/note_v1 --go_opt=paths=import \
	...
	mv pkg/note_v1/github.com/MaksMalf/testGrpc/pkg/note_v1/* pkg/note_v1/
